...
<div style="margin: auto;width: 60%;">
	<h2>Login & Register using PHP, Ajax And MySqli</h2>
	...
	<form id="register_form" name="form1" method="post">
		...
		<center>
			<h2>Already a member then <button type="button" class="btn btn-success btn-sm" id="login">Login</button></h2>
		</center>
	</form>
	<form id="login_form" name="form1" method="post" style="display:none;">
		...
		<input type="reset" class="btn btn-primary" value="Cancel">
		<center>
			<h2>Kindly Register to Know More <button type="button" class="btn btn-success btn-sm" id="register">Register</button></h2>
		</center>
	</form>
</div>
